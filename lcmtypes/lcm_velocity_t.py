...
class lcm_velocity_t(object):
    __slots__ = ["utime", "command_v_mps", "position_m", "cycle_start"]
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(lcm_velocity_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != lcm_velocity_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return lcm_velocity_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x761cd5fc6e049c14) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if lcm_velocity_t._packed_fingerprint is None:
            lcm_velocity_t._packed_fingerprint = struct.pack(">Q", lcm_velocity_t._get_hash_recursive([]))
        return lcm_velocity_t._packed_fingerprint
